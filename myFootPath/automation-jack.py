# -*- coding: utf-8 -*-
"""
Created on Sun Aug  7 19:05:13 2022
...
while cont==False:
    try:
        not_enrolled=recent_file(f'C:/Users/{username}/Box Sync/ReEngage NAU Reports/Registrar Reports Automated/Group_NotEnrolled-{today}*','.csv',1)
        enrolled=recent_file(f'C:/Users/{username}/Box Sync/ReEngage NAU Reports/Registrar Reports Automated/Group_Enrolled-{today}*','.csv',1)
        billing_dfX=pd.read_excel(f'C:/Users/{username}/Box Sync/Northern Arizona/Reporting/Billing Reports/CloseIO ReEngage Sync.xlsx',sheet_name="Student Starts",usecols='A:J')
        fina=recent_file(f'C:/Users/{username}/Box Sync/ReEngage NAU Reports/Financial Aid Reports Automated/current_fina_checklist_items-{today}*','.csv',1)
        fafsa=recent_file(f'C:/Users/{username}/Box Sync/ReEngage NAU Reports/Financial Aid Reports Automated/fafsa_loan_docs-{today}*','.csv',1)
        to_do=recent_file(f'C:/Users/{username}/Box Sync/ReEngage NAU Reports/To Do List Report Automated/to_do_list-{today}*','.csv',1)
        holds=recent_file(f'C:/Users/{username}/Box Sync/ReEngage NAU Reports/To Do List Report Automated/holds-{today}*','.csv',1)
        cont=True
    except:
        if loop<12:
            ...
            not_enrolled=recent_file(f'C:/Users/{username}/Box Sync/ReEngage NAU Reports/Registrar Reports Automated/Group_NotEnrolled-*','.csv',1)
            enrolled=recent_file(f'C:/Users/{username}/Box Sync/ReEngage NAU Reports/Registrar Reports Automated/Group_Enrolled-*','.csv',1)
            billing_dfX=pd.read_excel(f'C:/Users/{username}/Box Sync/Northern Arizona/Reporting/Billing Reports/CloseIO ReEngage Sync.xlsx',sheet_name="Student Starts",usecols='A:J')
            fina=recent_file(f'C:/Users/{username}/Box Sync/ReEngage NAU Reports/Financial Aid Reports Automated/current_fina_checklist_items-*','.csv',1)
            fafsa=recent_file(f'C:/Users/{username}/Box Sync/ReEngage NAU Reports/Financial Aid Reports Automated/fafsa_loan_docs-*','.csv',1)
            to_do=recent_file(f'C:/Users/{username}/Box Sync/ReEngage NAU Reports/To Do List Report Automated/to_do_list-*','.csv',1)
            holds=recent_file(f'C:/Users/{username}/Box Sync/ReEngage NAU Reports/To Do List Report Automated/holds-*','.csv',1)
            warning.warn('THE FILES ARE NOT UP TO DATE')
            cont=True
#Turn them into data frames
not_enrolled_df=pd.read_csv(not_enrolled)
not_enrolled_df.to_sql('not_enrolled_daily',con=pool,index=False)
enrolled_df=pd.read_csv(enrolled)
enrolled_df.to_sql('enrolled_daily',con=pool,index=False)
...
fafsa_df=pd.read_csv(fafsa,on_bad_lines='warn')
fafsa_df.to_sql('fafsa_daily',con=pool,index=False)
...
#Holds Detail
holds_df=pd.read_csv(holds,on_bad_lines='warn')
holds_df.to_sql('holds_daily',con=pool,index=False)
...
to_do_df=pd.read_csv(to_do,on_bad_lines='warn')
to_do_df.to_sql('to_do_daily',con=pool,index=False)
...
fina_df=pd.read_csv(fina,on_bad_lines='warn')
...
first_day_df=pd.read_csv(f'C:/Users/{username}/Box Sync/ReEngage NAU Reports/Registrar Reports Automated/Group_Enrolled-2022-01-07 06-07-15 AM.csv')
first_not_df=pd.read_csv(f'C:/Users/{username}/Box Sync/ReEngage NAU Reports/Registrar Reports Automated/Group_NotEnrolled-2022-01-07 06-07-19 AM.csv')
yesterday_df=pd.read_csv(recent_file(f'C:/Users/{username}/Box Sync/ReEngage NAU Reports/Registrar Reports Automated/Group_Enrolled*','.csv',2))
...
dfDropped2.to_csv(f'C:/Users/{username}/Box Sync/Northern Arizona/Operations/Analysis/Find_Drop_Students/{today} Find_Dropped_Classes.csv',index=False)
dfAdded2.to_csv(f'C:/Users/{username}/Box Sync/Northern Arizona/Operations/Analysis/Find_Add_Students/{today} Find_Added_Classes.csv',index=False)
enrolled_df.to_csv(f'C:/Users/{username}/Box Sync/Northern Arizona/Operations/Analysis/Find_Drop_Students/Enrolled_Today.csv',index=False)
yesterday_df.to_csv(f'C:/Users/{username}/Box Sync/Northern Arizona/Operations/Analysis/Find_Drop_Students/Enrolled_Yesterday.csv',index=False)
...
close_df.to_sql('close_daily',con=pool,index=False)
...
billed_students_df=pd.read_excel(f'C:/Users/{username}/Downloads/2022-01-31_Billed_Students.xlsx')
...
not_enrolled_new.to_csv(f'C:/Users/{username}/Box Sync/Northern Arizona/Reporting/Registrar Course Reports/Not Enrolled New/{today} Not Enrolled New.csv')
not_enrolled_cont.to_csv(f'C:/Users/{username}/Box Sync/Northern Arizona/Reporting/Registrar Course Reports/Not Enrolled Continuing/{today} Not Enrolled Continuing.csv')
...
enrolled_new.to_csv(f'C:/Users/{username}/Box Sync/Northern Arizona/Reporting/Registrar Course Reports/Enrolled New/{today} Enrolled New.csv')
enrolled_cont.to_csv(f'C:/Users/{username}/Box Sync/Northern Arizona/Reporting/Registrar Course Reports/Enrolled Continuing/{today} Enrolled Continuing.csv')
...
remainX.to_csv(f"C:/Users/{username}/Box Sync/Northern Arizona/Reporting/Uploads to close io/Enrollment Groups Workbook/Existing Students Course Count Updates/{today} Existing Course Count Upload.csv",index=False)
lost.to_csv(f"C:/Users/{username}/Box Sync/Northern Arizona/Reporting/Uploads to close io/Enrollment Groups Workbook/Enrolled Not In Close/{today} Enrolled Not In Close.csv",index=False)
join_not_enrolled.to_csv(f"C:/Users/{username}/Box Sync/Northern Arizona/Reporting/Uploads to close io/Enrollment Groups Workbook/New Students - Not Enrolled/{today} New Not Enrolled.csv",index=False)
...
writing_to_workbook(f"C:/Users/{username}/{today} Enrollment Groups.xlsx",f"C:/Users/{username}/Box Sync/Northern Arizona/Reporting/Uploads to close io/Enrollment Groups Workbook/Enrollment Groups Workbooks - Complete/{today} Enrollment Groups.xlsx",enrolled,"Enrolled",not_enrolled,"Not Enrolled",close,"Close",f"C:/Users/{username}/Box Sync/Northern Arizona/Reporting/Uploads to close io/Enrollment Groups Workbook/Existing Students Course Count Updates/{today} Existing Course Count Upload.csv","Existing Students",f"C:/Users/{username}/Box Sync/Northern Arizona/Reporting/Uploads to close io/Enrollment Groups Workbook/New Students - Not Enrolled/{today} New Not Enrolled.csv","Active Students No Courses",f'C:/Users/{username}/quarter.csv',"New Enrolled This Quarter",f'C:/Users/{username}/quarter2.csv',"Existing Enrolled",f'C:/Users/{username}/not.csv',"New Not Enrolled This Quarter",f'C:/Users/{username}/not2.csv',"Existing Not Enrolled")
